...
<p class="pseudocode">
  ...
  &emsp;&emsp;
  <span class="pseudocode__highlight">statements</span><br />
  <span>&rcub;</span> <span class="pseudocode__keyword">while</span> <span class="pseudocode__highlight">condition</span>
</p>
...
<p class="pseudocode">
  <span class="pseudocode__keyword">switch</span> <span class="pseudocode__highlight">some value to consider</span> &lcub; <br />
  <span class="pseudocode__keyword">case</span> <span class="pseudocode__highlight">value 1</span>: <br />
  &emsp;&emsp;<span class="pseudocode__highlight">respond to value 1</span><br />
  <span class="pseudocode__keyword">case</span> <span class="pseudocode__highlight">value 2</span>, <span class="pseudocode__highlight">value 3</span>:<br />
  &emsp;&emsp;<span class="pseudocode__highlight">respond to value 2 or 3</span><br />
  <span class="pseudocode__keyword">default</span>:<br />
  &emsp;&emsp;<span class="pseudocode__highlight">otherwise, do something else</span><br />
  &rcub;
</p>
...
The `continue`, `break`, and `fallthrough` statements are described below. The `return` statement is described in [Functions](./functions), and the `throw` statement is described in [Propagating Errors Using Throwing Functions](./error-handling/propagating-errors-using-throwing-functions).
...
<p class="pseudocode">
  <span class="pseudocode__highlight">label name</span>: <span class="pseudocode__keyword">while</span> <span class="pseudocode__highlight">condition</span> <br />
  &emsp;&emsp;
  <span class="pseudocode__highlight">statements</span><br />
  <span>&rcub;</span>
</p>
...
<p class="pseudocode">
  <span class="pseudocode__keyword">if #available</span> (<span class="pseudocode__highlight">platform name</span> <span class="pseudocode__highlight">version</span>, <span class="pseudocode__highlight">...</span>, *) &lcub; <br />
  &emsp;&emsp;
