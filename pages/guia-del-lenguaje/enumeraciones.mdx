...
For more about these capabilities, see [Properties](./propiedades), [Methods](./metodos), [Initialization](./inicializacion), [Extensions](./extensiones), and [Protocols](./protocolos).
