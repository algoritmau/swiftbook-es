...
This function makes use of in-out parameters to swap the values of a and b, as described in [In-Out Parameters](./funciones#parámetros-in-out).
...
<DynamicImage
  baseName="stackPushedFourStrings"
  alt="Illustration of push and pop behavior on a stack"
  width={743}
  height={271}
/>
