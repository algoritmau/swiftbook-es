...
Adding protocol conformance in this way is described in [Adding Protocol Conformance with an Extension](./protocolos#adding-protocol-conformance-with-an-extension).

An extension can be used to extend an existing generic type, as described in [Extending a Generic Type](./genericos#extending-a-generic-type). You can also extend a generic type to conditionally add functionality, as described in [Extensions with a Generic Where Clause](./genericos#extensions-with-a-generic-where-clause).
