...
<p class="pseudocode">
  <span class="pseudocode__keyword">while</span>{' '}
  <span class="pseudocode__highlight">condition</span> &lcub; <br />
  &emsp;&emsp;
  <span class="pseudocode__highlight">statements</span>
  <br />
  <span>&rcub;</span>
</p>
...
<img
  src="/assets/images/snakesAndLadders_2x.png"
  alt="Illustration with instructions for the Snakes and Ladders game"
  width={623}
  height={299}
...
<Callout>
  The `repeat-while` loop in Swift is analogous to a `do-while` loop in other
  languages.
</Callout>
...
<p class="pseudocode">
  <span class="pseudocode__keyword">repeat</span> &lcub; <br />
  &emsp;&emsp;
  <span class="pseudocode__highlight">statements</span>
  <br />
  <span>&rcub;</span> <span class="pseudocode__keyword">while</span>{' '}
  <span class="pseudocode__highlight">condition</span>
</p>
...
<p class="pseudocode">
  <span class="pseudocode__keyword">switch</span>{' '}
  <span class="pseudocode__highlight">some value to consider</span> &lcub;{' '}
  <br />
  <span class="pseudocode__keyword">case</span> <span class="pseudocode__highlight">
    value 1
  </span>: <br />
  &emsp;&emsp;<span class="pseudocode__highlight">respond to value 1</span>
  <br />
  <span class="pseudocode__keyword">case</span>{' '}
  <span class="pseudocode__highlight">value 2</span>,{' '}
  <span class="pseudocode__highlight">value 3</span>:<br />
  &emsp;&emsp;<span class="pseudocode__highlight">respond to value 2 or 3</span>
  <br />
  <span class="pseudocode__keyword">default</span>:<br />
  &emsp;&emsp;
  <span class="pseudocode__highlight">otherwise, do something else</span>
  <br />
  &rcub;
</p>
...
<Callout>
  ...
  Statement](#break-in-a-switch-statement).
</Callout>
...
<Callout>
  ...
  `fallthrough` keyword, as described in [Fallthrough](#fallthrough).
</Callout>
...
<img
  src="/assets/images/coordinateGraphSimple_2x.png"
  alt="Two-dimension cartesian plane"
  width={288}
  height={288}
  className="figure-small"
/>
...
<img
  src="/assets/images/coordinateGraphMedium_2x.png"
  alt="Two-dimension cartesian plane"
  width={288}
  height={288}
  className="figure-small"
...
<img
  src="/assets/images/coordinateGraphComplex_2x.png"
  alt="Two-dimension cartesian plane"
  width={289}
  height={290}
  className="figure-small"
...
The `continue`, `break`, and `fallthrough` statements are described below. The `return` statement is described in [Functions](./funciones), and the `throw` statement is described in [Propagating Errors Using Throwing Functions](./manejo-de-errores#propagacion-de-errores-mediante-funciones-throwing).
...
<p class="pseudocode">
  <span class="pseudocode__highlight">label name</span>:{' '}
  <span class="pseudocode__keyword">while</span>{' '}
  <span class="pseudocode__highlight">condition</span> <br />
  &emsp;&emsp;
  <span class="pseudocode__highlight">statements</span>
  <br />
  <span>&rcub;</span>
...
<Callout>
  ...
  label makes it clear which control statement should be terminated. It isn't
  strictly necessary to use the `gameLoop` label when calling `continue
...
In its general form, the availability condition takes a list of platform names and versions. You use platform names such as `iOS`, `macOS`, `watchOS`, and `tvOS`—for the full list, see [Declaration Attributes](../referencia-del-lenguaje/atributos#atributos-de-declaracion). In addition to specifying major version numbers like iOS 8 or macOS 10.10, you can specify minor versions numbers like iOS 11.2.6 and macOS 10.13.3.

<p class="pseudocode">
  <span class="pseudocode__keyword">if #available</span> (
  <span class="pseudocode__highlight">platform name</span>{' '}
  <span class="pseudocode__highlight">version</span>,{' '}
  <span class="pseudocode__highlight">...</span>, *) &lcub; <br />
  &emsp;&emsp;
  <span class="pseudocode__highlight">statements to execute if the APIs are available</span><br />
  &rcub; <span class="pseudocode__keyword">else</span> &lcub; <br />
  &emsp;&emsp;
  <span class="pseudocode__highlight">fallback statements to execute if the APIs are unavailable</span><br />
  &rcub;
</p>
